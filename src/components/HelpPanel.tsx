...
export default function HelpPanel() {
  ...
  return (
    <>
      {/* Floating Button */}
      <button
        className="fixed bottom-6 right-6 z-[998] w-12 h-12 rounded-full bg-accent text-white shadow-lg flex items-center justify-center hover:bg-accent-hover transition-all hover:scale-105 cursor-pointer"
